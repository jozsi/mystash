...
- Copy the `config.js.sample` file, renaming it to `config.js`. Edit the new file (`config.js`) filling in the necessary information for your local machine (e.g. the local connection to MongoDB)
...
### Running tests
- To run all the tests, run `node tests`
